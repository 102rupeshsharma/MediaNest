...
[@fotoowl/media-react](../globals.md) / useSearchVideos

# Function: useSearchVideos()

> **useSearchVideos**(`query`, `page?`, `perPage?`): `UseQueryResult`\<`NormalizedResponse`\<[`MediaItem`](../interfaces/MediaItem.md)\>, `Error`\>

Defined in: [media-react/src/index.tsx:164](https://github.com/102rupeshsharma/MediaNest/blob/fa3ed149117b674b2958a0900a6f83c1ee86c661/packages/media-react/src/index.tsx#L164)
